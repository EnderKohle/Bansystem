			...
			if (BanSystem.mysql.isConnected()) {
				if (args.length == 1) {
					...
					if (bm.isBannedChat(id) && bm.isBannedNetwork(id)) {
						...
						sender.sendMessage(BanSystem.PREFIX + "§7Von §8» §c" + bm.getBanner(id, Type.CHAT));
						sender.sendMessage(BanSystem.PREFIX + "§7Grund §8» §c" + bm.getReasonChat(id));
						sender.sendMessage(BanSystem.PREFIX + "§7Verbleibende Zeit §8» §c" + bm.getRemainingTime(id, bm.getReasonChat(id)));
						...
						sender.sendMessage(BanSystem.PREFIX + "§7Von §8» §c" + bm.getBanner(id, Type.NETWORK));
						sender.sendMessage(BanSystem.PREFIX + "§7Grund §8» §c" + bm.getReasonNetwork(id));
						sender.sendMessage(BanSystem.PREFIX + "§7Verbleibende Zeit §8» §c" + bm.getRemainingTime(id, bm.getReasonNetwork(id)));
						sender.sendMessage(BanSystem.PREFIX + "§7Type §8» §c" + Type.NETWORK);
						sender.sendMessage(BanSystem.PREFIX + "§7Level §8» §c" + bm.getLevel(id, bm.getReasonNetwork(id)));
					...
					sender.sendMessage(BanSystem.messages.getString("Check.usage")
							.replaceAll("%P%", BanSystem.PREFIX)
							.replaceAll("&", "§"));
				}
			} else {
